...
class RegisterFile32Baremetal extends InstanceFactory{
   ...
   RegisterFile32Baremetal() {
      super("RegisterFile32Baremetal", new SimpleStringGetter("32x32 Register File Baremetal"));
      int spacing = 10;
