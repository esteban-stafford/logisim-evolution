...
public class RiscvALUDecoderExtended extends ProgrammableComponent
{
    ...
    "       \n" +
    "       Value ALUControl = Value.createKnown(BitWidth.create(4), 0);\n"+
    "       \n" +
    "       state.setPort(nameToId.get(\"ALUControl\"), ALUControl, 4);\n";
    ...
    protected RiscvALUDecoderExtended()
    {
       super("RiscvALUDecoderExt", behaviorClassImplementationBody);
       int spacing = 10;
       ...
       setPorts(new Port[] {
          ...
          new Port(x1,             y0 + 4*spacing, Port.OUTPUT, 4)  // ALUCONTROL
       });
