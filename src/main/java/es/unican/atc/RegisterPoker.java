...
import static es.unican.atc.RegisterUtils.*;
...
public class RegisterPoker extends InstancePoker {
    ...
    public void keyTyped(InstanceState state, KeyEvent e) {
        ...
        RegisterData data = RegisterData.get(state, 32, 32);
        if (idx < 1) {
            return;
        }
        ...
        int old = (data.regs[idx].isFullyDefined() ? (int)data.regs[idx].toLongValue() : 0);
