package com.cburch.logisim.uc.gray;
...
public class SimpleGrayCounter extends InstanceFactory {
    ...
    public void propagate(InstanceState state) {
        ...
        boolean trigger = false; //cur.updateClock(state.getPort(0));
    ...
    public void paintInstance(InstancePainter painter) {
        ...
        if(painter.getShowState()) {
            ...
            GraphicsUtil.drawCenteredText(painter.getGraphics(),
                    StringUtil.toHexString(BIT_WIDTH.getWidth(), 10 /*state.getValue().toIntValue()*/),
